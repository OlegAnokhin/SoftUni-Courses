namespace _02.VehiclesExtension
{
    ...
    {
        private const double FuelConsumptionWithAC = 1.4;
        ...
        {
            double neededFuel = distance * (base.FuelConsumpion + FuelConsumptionWithAC);
        ...
        {
            double neededFuel = distance * base.FuelConsumpion;
            if (neededFuel <= base.FuelQuantity)
            {
                base.FuelQuantity -= neededFuel;
                Console.WriteLine($"Bus travelled {distance} km");

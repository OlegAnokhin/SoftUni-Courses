    ...
    public class ArenaTests
    {
        ...
        public void TestConstructorInitializesEmptyCollectionOfWarrior()
        {
            ...
            CollectionAssert.AreEqual(expectedCollection, actualCollection,
                "Arena constructor should initialize an empty collection!");
        }
        [Test]
        ...
        [Test]
        public void CountShoulReturnZeroOnEmptyArena()
        {
            int actualCount = this.arena.Count;
            int expectedCount = 0;
            Assert.AreEqual(expectedCount, actualCount,
                "Count should return zero when are no enrolled Warriors!");
        }
        [Test]
        public void CountShouldReturnCorrectValueWhenThereEnrolledWarriors()
        {
        ...
        [Test]
        public void EnrollShoudThrowAnExceptionWhenEnrollindExistWarrior()
        {
            Warrior warrior = new Warrior("Pesho", 50, 100);
            this.arena.Enroll(warrior);
        ...
        [Test]
        public void FightBetweenInExistingDeffenderShouldThrowException()
        {
            Warrior warrior = new Warrior("Pesho", 50, 100);
            this.arena.Enroll(warrior);
            Assert.Throws<InvalidOperationException>(() =>
        ...
        [Test]
        public void FightBetweenExistingWarriorsShouldSucceses()
        {
            ...
            int actualDeffenderHp = warriorD.HP;
